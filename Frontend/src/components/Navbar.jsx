                ...
                <nav className='flex gap-7 items-center'>
                    ...
                    {user ? (
                        <div className="flex items-center gap-3">
                            <span className="font-semibold text-gray-700 hidden md:block" title={user.email}>Hi, {user.name || "User"}</span>
                            <button onClick={logout} className="bg-red-500 text-white px-4 py-1 rounded-md text-sm cursor-pointer hover:bg-red-600">Logout</button>
                        </div>
                    ) : (
                        <Link to='/login' className="bg-blue-600 text-white px-4 py-1 rounded-md text-sm cursor-pointer hover:bg-blue-700">Login</Link>
                    )}
                    {
